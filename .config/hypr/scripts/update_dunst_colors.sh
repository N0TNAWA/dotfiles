...
sed -i "s/frame_color = .*/frame_color = \"${color3}\"/g" "$DUNST_CONFIG"
...
sed -i "s/urgency_low.frame_color = .*/urgency_low.frame_color = \"${color3}\"/g" "$DUNST_CONFIG"
...
sed -i "s/urgency_normal.frame_color = .*/urgency_normal.frame_color = \"${color3}\"/g" "$DUNST_CONFIG"
...
sed -i "s/urgency_critical.frame_color = .*/urgency_critical.frame_color = \"${color3}\"/g" "$DUNST_CONFIG"
